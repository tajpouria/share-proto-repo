...
function serialize_identitypb_GetRequest(arg) {
  if (!(arg instanceof identity_pb.GetRequest)) {
...
function deserialize_identitypb_GetRequest(buffer_arg) {
  return identity_pb.GetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_identitypb_NewRequest(arg) {
  if (!(arg instanceof identity_pb.NewRequest)) {
...
function deserialize_identitypb_NewRequest(buffer_arg) {
  return identity_pb.NewRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var IdentityServiceService = exports.IdentityServiceService = {
  new: {
    ...
    requestType: identity_pb.NewRequest,
  ...
  get: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: identity_pb.GetRequest,
    responseType: identity_pb.Identity,
