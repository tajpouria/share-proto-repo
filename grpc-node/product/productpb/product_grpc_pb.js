...
var product_productpb_product_pb = require('../../product/productpb/product_pb.js');
var github_com_gogo_protobuf_gogoproto_gogo_pb = require('../../github.com/gogo/protobuf/gogoproto/gogo_pb.js');

function serialize_productpb_GetRequest(arg) {
  if (!(arg instanceof product_productpb_product_pb.GetRequest)) {
...
function deserialize_productpb_GetRequest(buffer_arg) {
  return product_productpb_product_pb.GetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_productpb_NewRequest(arg) {
  if (!(arg instanceof product_productpb_product_pb.NewRequest)) {
...
function deserialize_productpb_NewRequest(buffer_arg) {
  return product_productpb_product_pb.NewRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_productpb_Product(arg) {
  if (!(arg instanceof product_productpb_product_pb.Product)) {
...
function deserialize_productpb_Product(buffer_arg) {
  return product_productpb_product_pb.Product.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ProductServiceService = exports.ProductServiceService = {
  new: {
    ...
    requestType: product_productpb_product_pb.NewRequest,
    responseType: product_productpb_product_pb.Product,
  ...
  get: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: product_productpb_product_pb.GetRequest,
    responseType: product_productpb_product_pb.Product,
